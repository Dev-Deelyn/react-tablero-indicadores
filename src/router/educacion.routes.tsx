...
import TecnicasAgrotecnicas from '../containers/educacion/tecnicasAgrotecnicas';
...
const routes: IndicatorRoutes[] = [
  ...
  { path: 'tecnicas-agrotecnicas', icon: routeIcon, title: 'técnicas y agrotécnicas', content: <TecnicasAgrotecnicas/> },
